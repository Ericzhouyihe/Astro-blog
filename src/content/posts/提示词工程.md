...
>
> **小白路线**：先看 4.1 和 4.2，理解提示词的三层结构和基础技术，建立直觉后进入第5章上下文工程，再看第6章推理模式。
>
...
配合 4.6 的版本注册表，日志中的版本号字段即可用于事故回溯——当线上效果下降时，通过比对不同版本的评测分数与日志，快速定位是"提示词变更"还是"外部环境变化"导致的回归。